...
public class TameableCreaturesPlugin : BaseUnityPlugin
{
	...
	private void Awake()
	{
		...
		ExtraFood = base.Config.Bind("General", "ExtraFood", "Wolf:BjornMeat", "Comidas extra por criatura, pares criatura:ítem separados por coma (ej: Wolf:BearMeat,Boar:Turnip). Vanilla excluye la carne de oso de la dieta del lobo.");
